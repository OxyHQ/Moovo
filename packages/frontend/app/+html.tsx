  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Primary Meta Tags */}
        <meta name="title" content="Moovo" />
        <meta
          name="description"
          content="Moovo by Oxy — buy and sell new and secondhand items from shops and people near you."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:url" content="https://moovo.now/" />
        <meta property="og:title" content="Moovo" />
        <meta
        ...
        <meta property="twitter:url" content="https://moovo.now/" />
        <meta property="twitter:title" content="Moovo" />
        <meta
        ...
        <meta name="apple-mobile-web-app-title" content="Moovo" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://moovo.now',
              description:
                'Moovo by Oxy — buy and sell new and secondhand items from shops and people near you.',
