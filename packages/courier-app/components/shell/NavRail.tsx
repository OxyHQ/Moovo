...
/* ================================================================
   ...
   longer hand-rolls the avatar/sign-in trigger. Collapsed rail → bare avatar
   (`expanded={false}`); the footer sits at the bottom, so the menu opens upward
   (ProfileButton's default `placement`).
   ================================================================ */
