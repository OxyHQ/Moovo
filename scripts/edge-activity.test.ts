...
const entries = ["../packages/frontend/worker/index.js", "../packages/courier-app/worker/index.js", "../packages/fleet-dashboard/worker/index.js", "../packages/tracker-app/worker/index.js"];
